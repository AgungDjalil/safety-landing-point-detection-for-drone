...
class DroneKinematic : public rclcpp::Node 
{
    ...
    private:
        ...
        void make_transforms()
        {
            ...
            // Mount transform from base_link to camera_link.
            // Values match the OakD-Lite <include> pose in
            // Tools/simulation/gz/models/x500_depth/model.sdf (x y z roll pitch yaw):
            //   <pose>0.22 0.03 0.242 0 1.5708 0</pose>
            transform.transform.translation.x = 0.22;
            transform.transform.translation.y = 0.03;
            transform.transform.translation.z = 0.242;
